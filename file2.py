...
# =========================================================
# 2. FEATURE SELECTION VỚI LIGHTGBM (BCE)
# =========================================================
print("🔍 Feature Selection với LightGBM (BCE)...")
...
print("\n🚀 Train LightGBM (BCE + scale_pos_weight)...")
...
print(f"✅ Đã lưu submission_Final.csv (TDEs: {sub['target'].sum()})")
